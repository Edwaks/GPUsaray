...
**GPUsaray** — сервис аренды вычислительных мощностей с графическими ускорителями. Продукт рассчитан на исследователи, разработчики и команды машинного обучения и делает выбор и аренду вычислительных ресурсов понятными, с расчётами в рублях.
...
- Ключевые возможности: витрина мощностей, сравнение конфигураций, цены в рублях, личный кабинет, заказы и периоды, контроль состояния и история начислений.

## Зачем нужен продукт

Рабочий процесс редко состоит из одного действия. Пользователю приходится понимать исходную ситуацию, собирать сведения, выбирать следующий шаг, согласовывать решение и возвращаться к результату позже. GPUsaray создаёт для этого единое предметное пространство. Оно помогает не терять контекст между этапами и видеть не только отдельную карточку, но и её место в общем процессе.

Главная ценность продукта — не количество экранов, а связность работы. Конфигурации, мощности, периоды аренды, заказы, начисления и состояние услуг рассматриваются как части одного пользовательского маршрута. Благодаря этому новый участник быстрее понимает состояние дела, опытный специалист тратит меньше времени на ручное сопоставление, а руководитель получает обозримую картину без пересказа каждого шага.
...
Роли Посетитель, Арендатор и Ответственный за расходы работают с одной предметной моделью, хотя видят её с разных сторон. Единые названия объектов и состояний уменьшают двусмысленность при передаче работы. Ответственный участник может сослаться на конкретный объект и ожидаемый результат, а не пересказывать весь контекст.

## Основные разделы

Публичное описание охватывает следующие пользовательские возможности:

- **Витрина мощностей** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Сравнение конфигураций** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Цены в рублях** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Личный кабинет** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Заказы и периоды** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Контроль состояния** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **История начислений** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
